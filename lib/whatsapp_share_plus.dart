...
class WhatsappShare {
  static const MethodChannel _channel = MethodChannel('whatsapp_share_plus');

  /// Checks whether whatsapp is installed in device or not
  ///
  /// [Package] is optional enum parameter which is defualt to
  /// [Package.whatsapp]
  /// for business whatsapp set it to [Package.businessWhatsapp],
  /// it cannot be null
  ///
  /// return true if installed otherwise false.
  static Future<bool?> isInstalled({Package package = Package.whatsapp}) async {
    String package0;
    package0 = package.index == 0 ? 'com.whatsapp' : 'com.whatsapp.w4b';
    final bool? success =
